...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-power-workbench PowerWorkbench id \'power-workbench\'',
  ...
  {
    key: 'power.workbench.inspector',
    kind: 'list',
    scope: 'session',
    summary: 'Secondary safety, provenance, and authorization inspectors.',
    doc: 'Secondary safety, provenance, and authorization inspectors.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.view\' (client-ui-power-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-power-workbench SafetyBoundaryPanel id \'safety-boundary\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Compact session summary cards above the engineering workspace.',
    doc: 'Compact session summary cards above the engineering workspace.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-power-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-power-workbench SessionPulsePanel id \'session-pulse\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Primary domain panels such as timing, control, logs, and build evidence.',
    doc: 'Primary domain panels such as timing, control, logs, and build evidence.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-power-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-power-workbench EngineeringWorkspacePanel id \'engineering-domains\'',
    ],
    replaceRisk: 'none',
