...
- **Marketplace is desktop-only** — the tab is absent in a plain browser. Install and uninstall call the desktop shell, which forwards to `dsh plugin --profile web` and restarts the Host.
