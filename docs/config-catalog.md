...
Requires: `sandboxPolicy` · `sandbox`
...
Source: [`packages/fs/fs-esafenet/src/index.ts:42`](../packages/fs/fs-esafenet/src/index.ts)
...
Source: [`packages/power/power-analysis/src/index.ts:36`](../packages/power/power-analysis/src/index.ts)
...
Source: [`packages/power/power-policy/src/index.ts:72`](../packages/power/power-policy/src/index.ts)
...
Source: [`packages/power/power-prompt/src/index.ts:29`](../packages/power/power-prompt/src/index.ts)
